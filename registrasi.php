...
if (isset($_POST['simpan'])){
	...
	$pass = $_POST ['pass'];
    $tlp = $_POST ['tlp'];
	$tambah = mysqli_query ($conn, "INSERT INTO masyarakat(nik,nama,alamat,rt_rw,,username,password,telp)VALUES('$nik','$nama','$alamat','$rtrw',','$user','$pass','$tlp')");
	if($tambah){
        ...
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2">
             ...
             <div class="slider_text ">
                                ...
                                <p style="color:white">Selamat datang di web Pengaduan Masyarakat Desa murukan<br>
